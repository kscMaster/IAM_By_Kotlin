...
public class IdNamePathMeta extends MongoColumnName{
    private String parentPropertyName;
    public IdNamePathMeta(String parentPropertyName) {
    ...
    this.path = MoerUtil.mongoColumnJoin(this.parentPropertyName, "path");
    }
    
    public IdNamePathMeta(MongoColumnName value) {
        this(value.toString());
    }
     ...
     */
    @nbcp.db.Cn(value = "路径")
    private MongoColumnName path = null;
    public MongoColumnName getPath(){
        return path;
    }
    @Override 
