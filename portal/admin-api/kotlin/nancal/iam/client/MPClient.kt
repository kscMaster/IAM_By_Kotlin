 ...
 * @Created by kxp
 */
@FeignClient(name = "mp-integration",
//    url = "http://192.168.5.213/api/mp-integration/",
    fallback = MPClientFallbackFactory::class)
interface MPClient {
    ...
    @PostMapping("lang/res")
    fun res(
        @RequestParam lang: String,
        @RequestParam productLineCode: String,
