...
//
//
//class GuiZeYinQingYApiGenExcelDataTest {
...
//    //规则引擎
//    private val guiZeApiDataUrl="http://192.168.5.213:31010/api/plugin/export?type=json&pid=424&status=all&isWiki=false"
...
//
//        val guiZelist = getGuizeApiData()
//        val guiZeData = mutableListOf<ApiVo>()
...
//        //输出excel
//        // 通过工具类创建writer
//        val writer = ExcelUtil.getWriter("${getDesktopUrl()}/接口数据-${IdUtil.fastUUID()}.xlsx","规则引擎")
//
//
//        //自定义标题别名
...
//        val map = JSON.parseObject(res, Map::class.java)
...
//        val jsonarr = JSON.parseArray(res)
//        var retrunRes = Convert.toCollection(ArrayList::class.java, Cate::class.java, jsonarr)
//        return retrunRes
//    }
//
...
//    }
//
//    fun getGuizeApiData(): Collection<*> {
//        var res = HttpUtil.get(guiZeApiDataUrl).replace("\n", "").ToJson()
//        val jsonarr = JSON.parseArray(res)
//        var retrunRes = Convert.toCollection(ArrayList::class.java, Cate::class.java, jsonarr)
//        return retrunRes
//    }
...
//        val jsonObj = JSON.parseObject(res)
//        if(0!=jsonObj.get("errcode")) return ""
//        return JSON.parseObject(jsonObj.get("data").toString()).get("username").toString()
//    }
//
